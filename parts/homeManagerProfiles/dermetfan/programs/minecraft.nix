...
let
  cfg = config.profiles.dermetfan.programs.minecraft;
in {
  options.profiles.dermetfan.programs.minecraft.enable = lib.mkEnableOption "minecraft" // {
    default = config.programs.minecraft.enable or false;
  };

  config.home.file.".minecraft/options.txt".text = ''
    version:922
    invertYMouse:false
